...
//
// ⚠️ SET YOUR DOMAIN HERE ⚠️
// `siteUrl` drives canonical tags, og:url, the sitemap, and the JSON-LD `url`.
// If it is wrong, Google will canonicalize to the wrong host. Either edit the
// fallback below, or set NEXT_PUBLIC_SITE_URL in the Vercel project settings
// (Settings → Environment Variables) — the env var wins.
//
// No trailing slash.
const FALLBACK_SITE_URL = "https://shayanpoigai.com"; // <-- REPLACE with your real custom domain
