...
export const sameAs = [
  ...
  "https://leetcode.com/u/shapoi/",
];

// Portrait used on /about. Also fed to the JSON-LD Person as `image` — it's
// the same photo as the LinkedIn and GitHub profiles, which gives Google a
// matching visual across all three when it resolves the entity.
export const portraitPath = "/images/pfp.jpeg";
