// ============================ EDIT ME ============================
// Ambient "captain's log" lines for the Work (/work) page. Each array item
...
//
// Keep the counts matching content.js (experience: 4, projects: 7). If they ever
  ...
  projects: [
    {
      ...
      stardate: "78702.3",
      label: "SWING AGENT",
      line: "28 SOURCES INGESTED // 0/38 PLACEBO FABRICATIONS",
    },
    {
      code: "02",
      stardate: "78705.1",
      label: "FUSION BENCH",
      line: "ONLINE SOFTMAX // 82% HBM PEAK // 1.78X",
    },
    {
      code: "03",
      stardate: "78190.2",
    ...
    },
    {
      ...
      stardate: "78150.6",
      label: "EVERMIND",
      line: "NEO4J MEMORY GRAPH // HUME VOICE LINK",
    },
    {
      code: "05",
      stardate: "78233.7",
